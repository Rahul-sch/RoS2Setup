...
class DriveModuleMeasuredValues(object):
    ...
    def xy_drive_velocity(self) -> Tuple[float, float]:
        angle = self.orientation_in_body_coordinates.z
        speed = self.drive_velocity_in_module_coordinates.x
        ...
        try:
            ...
            # math domain error if upstream publishes +/-inf; fall back to zero
            return 0.0, 0.0
